...
optional_columns = ['rating', 'ratingsCount', 'reviewsCount', 'genres', 'coverImg', 'publishedDate']
...
if missing_optional:
    print(f"Missing optional columns: {missing_optional}")
    print("These columns will be created with default values.")
...
# Fill missing data for optional columns
...
# Handle cover image
if 'coverImg' not in df.columns:
    df['coverImg'] = None

# Handle published date
if 'publishedDate' not in df.columns:
    df['publishedDate'] = None
